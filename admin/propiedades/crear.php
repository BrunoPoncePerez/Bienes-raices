...
<main class="contenedor seccion">
    ...
    <form class="formulario" method="POST" action="/admin/propiedades/crear.php" enctype="multipart/form-data">
                                                                              <!-- enctype="multipart/form-data" es necesario en 
                                                                            cualquier tecnologia ya sea de backend o de web, nodejs,
                                                                        es necesario habilitarlo ya que nos permite leer archivos -->                
